...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ✅ 3. Call the login function from the context instead of using fetch
      ...
      if (success) {
        ...
        // If login fails, the context will return false
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-black via-[#0a0a0a] to-[#1a0033] animate-fadeIn">
      <Background />
      <div className="relative w-[380px] p-[5px] bg-[#0d0d0d] rounded-2xl shadow-lg shadow-purple-900 overflow-hidden">
